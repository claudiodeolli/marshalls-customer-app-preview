          ...
          <div className="card-body">
            ...
            <div className="_contact-row mb-1 rounded" style={{ background: '#f4f4f4' }}>
              <div className="_contact-info">
                <div className="_contact-icon-wrap" style={{ background: '#25D366' }}>
                ...
                <div>
                  <div className="font-weight-bold _contact-title">WhatsApp</div>
                  <div className="text-muted _contact-subtitle">Atendimento via mensagem</div>
                </div>
              </div>
              <a
            ...
            <div className="_contact-row rounded" style={{ background: '#f4f4f4' }}>
              <div className="_contact-info">
                <div className="_contact-icon-wrap" style={{ background: '#003DFF' }}>
                ...
                <div>
                  <div className="font-weight-bold _contact-title">E-mail</div>
                  <div className="text-muted _contact-subtitle">contato@marshallsmed.com.br</div>
                </div>
              </div>
              <a
