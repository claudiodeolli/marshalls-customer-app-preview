      ...
      <div className="col-12 col-md-8 col-lg-6">
        <div className="card">
          ...
          <div className="card-body">
            ...
            {/* WhatsApp */}
            <div className="d-flex align-items-center p-1 mb-1 rounded" style={{ background: '#f4f4f4' }}>
              <div className="mr-1" style={{ width: 40, height: 40, borderRadius: '50%', background: '#25D366', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
            ...
            {/* E-mail */}
            <div className="d-flex align-items-center p-1 rounded" style={{ background: '#f4f4f4' }}>
              <div className="mr-1" style={{ width: 40, height: 40, borderRadius: '50%', background: '#003DFF', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
