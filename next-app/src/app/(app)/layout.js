...
export default function AppGroupLayout({ children }) {
  ...
  // Quem rola é a página, como no projeto de referência do cliente. As três
  // formas cobrem os navegadores que divergem sobre qual elemento é o
  // scroller do documento.
  useEffect(() => {
    window.scrollTo(0, 0);
